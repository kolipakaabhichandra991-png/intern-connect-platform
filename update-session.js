const fs = require('fs');
let content = fs.readFileSync('src/lib/supabase/useSession.ts', 'utf8');
...
fs.writeFileSync('src/lib/supabase/useSession.ts', content, 'utf8');
console.log('Updated useSession!');
