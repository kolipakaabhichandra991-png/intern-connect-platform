      ...
      <div className="relative z-10 w-full max-w-4xl p-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center">
          ...
          <Link href="/login?role=admin" className="flex-1 group text-left">
            <div className="h-full bg-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] backdrop-blur-xl border-2 border-black p-10 rounded-2xl flex flex-col items-center text-center transition-all hover:bg-white shadow-[2px_2px_0_0_rgba(0,0,0,1)] hover:border-black hover:shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
              ...
              <div className="mt-auto w-full py-4 rounded-xl border-2 border-black bg-[#8A2BE2] text-white font-bold tracking-widest uppercase text-sm group-hover:bg-[#7a20c9] transition-colors">
                Enter Workspace
              </div>
            </div>
          </Link>
          ...
          <Link href="/login?role=intern" className="flex-1 group text-left">
            <div className="h-full bg-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] backdrop-blur-xl border-2 border-black p-10 rounded-2xl flex flex-col items-center text-center transition-all hover:bg-white shadow-[2px_2px_0_0_rgba(0,0,0,1)] hover:border-black hover:shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
              ...
              <div className="mt-auto w-full py-4 rounded-xl border-2 border-black bg-[#00f2fe] text-slate-900 font-bold tracking-widest uppercase text-sm group-hover:bg-[#00d2dd] transition-colors">
                Enter Portal
              </div>
            </div>
          </Link>
